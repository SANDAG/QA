...
hh_jur$reg<-hh_region[match(hh_jur$yr_id, hh_region$yr_id),"N_chg"]
hh_cpa$reg<-hh_region[match(hh_cpa$yr_id, hh_region$yr_id),"N_chg"]

hh_jur$regN<-hh_region[match(hh_jur$yr_id, hh_region$yr_id),"hhp"]
hh_cpa$regN<-hh_region[match(hh_cpa$yr_id, hh_region$yr_id),"hhp"]
