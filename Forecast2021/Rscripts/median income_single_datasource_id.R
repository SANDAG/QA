#median income plot and table for one datasource id
#do I need the write.csv to the temp folder ~line 75
#error at line 158 - ask Anne
...
cpa_id <- subset(geo_id, geo_id$id>20)
