...
est_test_prop_5 <- function(dataset, geographyid) { 
...
est_test_abso_5 <- function(dataset, geographyid, categoryid) { 
...
est_test_prop_10 <- function(dataset, geographyid) { 
...
est_test_abso_10 <- function(dataset, geographyid, categoryid) { 
