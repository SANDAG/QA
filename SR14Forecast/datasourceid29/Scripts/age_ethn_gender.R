#Forecast id29 - age ethn gender trends
...
write.csv(dem_age, paste("M:\\Technical Services\\QA Documents\\Projects\\Sub Regional Forecast\\4_Data files\\Phase 8\\age_ethn_gender\\dem_age_",ds_id,".csv",sep=''))
write.csv(dem_gender, paste("M:\\Technical Services\\QA Documents\\Projects\\Sub Regional Forecast\\4_Data files\\Phase 8\\age_ethn_gender\\dem_gender_",ds_id,".csv",sep=''))
write.csv(dem_ethn, paste("M:\\Technical Services\\QA Documents\\Projects\\Sub Regional Forecast\\4_Data files\\Phase 8\\age_ethn_gender\\dem_ethn_",ds_id,".csv",sep=''))
#write.csv(age_by_gender, paste("M:\\Technical Services\\QA Documents\\Projects\\Sub Regional Forecast\\4_Data files\\Phase 8\\age_ethn_gender\\age_by_gender_",ds_id,".csv",sep='')) 

write.csv(dem_age_region, paste("M:\\Technical Services\\QA Documents\\Projects\\Sub Regional Forecast\\4_Data files\\Phase 8\\age_ethn_gender\\dem_age_region_",ds_id,".csv",sep=''))
write.csv(dem_gender_region, paste("M:\\Technical Services\\QA Documents\\Projects\\Sub Regional Forecast\\4_Data files\\Phase 8\\age_ethn_gender\\dem_gender_region_",ds_id,".csv",sep=''))
write.csv(dem_ethn_region, paste("M:\\Technical Services\\QA Documents\\Projects\\Sub Regional Forecast\\4_Data files\\Phase 8\\age_ethn_gender\\dem_ethn_region_",ds_id,".csv",sep=''))
#write.csv(age_by_gender_region, paste("M:\\Technical Services\\QA Documents\\Projects\\Sub Regional Forecast\\4_Data files\\Phase 8\\age_ethn_gender\\age_by_gender_region_",ds_id,".csv",sep=''))

write.csv(dem_age_jurisdiction, paste("M:\\Technical Services\\QA Documents\\Projects\\Sub Regional Forecast\\4_Data files\\Phase 8\\age_ethn_gender\\dem_age_jurisdiction_",ds_id,".csv",sep=''))
write.csv(dem_gender_jurisdiction, paste("M:\\Technical Services\\QA Documents\\Projects\\Sub Regional Forecast\\4_Data files\\Phase 8\\age_ethn_gender\\dem_gender_jurisdiction_",ds_id,".csv",sep=''))
write.csv(dem_ethn_jurisdiction, paste("M:\\Technical Services\\QA Documents\\Projects\\Sub Regional Forecast\\4_Data files\\Phase 8\\age_ethn_gender\\dem_ethn_jurisdiction_",ds_id,".csv",sep='' ))
#write.csv(age_by_gender, paste("M:\\Technical Services\\QA Documents\\Projects\\Sub Regional Forecast\\4_Data files\\Phase 8\\age_ethn_gender\\age_by_gender_jurisdiction_",ds_id,".csv",sep=''))

write.csv(dem_age_cpa, paste("M:\\Technical Services\\QA Documents\\Projects\\Sub Regional Forecast\\4_Data files\\Phase 8\\age_ethn_gender\\dem_age_cpa_",ds_id,".csv",sep=''))
write.csv(dem_gender_cpa, paste("M:\\Technical Services\\QA Documents\\Projects\\Sub Regional Forecast\\4_Data files\\Phase 8\\age_ethn_gender\\dem_gender_cpa_",ds_id,".csv",sep=''))
write.csv(dem_ethn_cpa, paste("M:\\Technical Services\\QA Documents\\Projects\\Sub Regional Forecast\\4_Data files\\Phase 8\\age_ethn_gender\\dem_ethn_cpa_",ds_id,".csv",sep=''))
#write.csv(age_by_gender, paste("M:\\Technical Services\\QA Documents\\Projects\\Sub Regional Forecast\\4_Data files\\Phase 8\\age_ethn_gender\\age_by_gender_cpa_",ds_id,".csv",sep=''))
