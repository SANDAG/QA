...
write.csv(hh, paste("M:\\Technical Services\\QA Documents\\Projects\\Sub Regional Forecast\\4_Data Files\\time stamp files\\hhincome_sql",format(Sys.time(), "_%Y%m%d_%H%M%S"),".csv",sep=""))
