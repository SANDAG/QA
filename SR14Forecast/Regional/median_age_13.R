...
write.csv(median_age_cpa, paste("M:\\Technical Services\\QA Documents\\Projects\\Sub Regional Forecast\\4_Data Files\\time stamp files\\median_age_cpa_sql-13",format(Sys.time(), "_%Y%m%d_%H%M%S"),".csv",sep=""))
write.csv(median_age_jur, paste("M:\\Technical Services\\QA Documents\\Projects\\Sub Regional Forecast\\4_Data Files\\time stamp files\\median_age_jur_sql-13",format(Sys.time(), "_%Y%m%d_%H%M%S"),".csv",sep=""))
write.csv(median_age_region, paste("M:\\Technical Services\\QA Documents\\Projects\\Sub Regional Forecast\\4_Data Files\\time stamp files\\median_age_sql-13",format(Sys.time(), "_%Y%m%d_%H%M%S"),".csv",sep=""))
...
write.csv(median_age_cpa, "M:\\Technical Services\\QA Documents\\Projects\\Sub Regional Forecast\\4_Data Files\\median_age_cpa_13.csv")
write.csv(median_age_jur, "M:\\Technical Services\\QA Documents\\Projects\\Sub Regional Forecast\\4_Data Files\\median_age_jur_13.csv")
write.csv(median_age_region, "M:\\Technical Services\\QA Documents\\Projects\\Sub Regional Forecast\\4_Data Files\\median_age_13.csv")
