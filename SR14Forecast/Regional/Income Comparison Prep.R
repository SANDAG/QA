...
inc_abm_13_cpa_melt <- melt(inc_abm_13_cpa, id.vars=c("cpa_13", "yr"))
setnames(inc_abm_13_cpa_melt,old=c("variable","value"),new=c("income_group_id","hh"))

inc_abm_13_cpa_melt$income_group_id <-as.character(inc_abm_13_cpa_melt$income_group_id)

inc_abm_13_cpa_melt$income_group_id[inc_abm_13_cpa_melt$income_group_id=="cat1"]<- "1"
inc_abm_13_cpa_melt$income_group_id[inc_abm_13_cpa_melt$income_group_id=="cat2"]<- "2"
inc_abm_13_cpa_melt$income_group_id[inc_abm_13_cpa_melt$income_group_id=="cat3"]<- "3"
inc_abm_13_cpa_melt$income_group_id[inc_abm_13_cpa_melt$income_group_id=="cat4"]<- "4"
inc_abm_13_cpa_melt$income_group_id[inc_abm_13_cpa_melt$income_group_id=="cat5"]<- "5"


inc_abm_13_cpa_melt$lower_bound[inc_abm_13_cpa_melt$income_group_id=="1"]<- 0
inc_abm_13_cpa_melt$upper_bound[inc_abm_13_cpa_melt$income_group_id=="1"]<- 29999
inc_abm_13_cpa_melt$lower_bound[inc_abm_13_cpa_melt$income_group_id=="2"]<- 30000
inc_abm_13_cpa_melt$upper_bound[inc_abm_13_cpa_melt$income_group_id=="2"]<- 59999
inc_abm_13_cpa_melt$lower_bound[inc_abm_13_cpa_melt$income_group_id=="3"]<- 60000
inc_abm_13_cpa_melt$upper_bound[inc_abm_13_cpa_melt$income_group_id=="3"]<- 99999
inc_abm_13_cpa_melt$lower_bound[inc_abm_13_cpa_melt$income_group_id=="4"]<- 100000
inc_abm_13_cpa_melt$upper_bound[inc_abm_13_cpa_melt$income_group_id=="4"]<- 149999
inc_abm_13_cpa_melt$lower_bound[inc_abm_13_cpa_melt$income_group_id=="5"]<- 150000
inc_abm_13_cpa_melt$upper_bound[inc_abm_13_cpa_melt$income_group_id=="5"]<- 349999
...
inc_abm_13_cpa_melt$interval_width<-inc_abm_13_cpa_melt$upper_bound-inc_abm_13_cpa_melt$lower_bound +1


inc_abm_13_cpa_melt<- inc_abm_13_cpa_melt[order(inc_abm_13_cpa_melt$cpa_13,inc_abm_13_cpa_melt$yr),]

inc_abm_13_cpa_melt <- data.table(inc_abm_13_cpa_melt)
inc_abm_13_cpa_melt[, cum_sum := cumsum(hh), by=list(yr, cpa_13)]

inc_abm_13_cpa_melt<-as.data.frame.matrix(inc_abm_13_cpa_melt) 

head(inc_abm_13_cpa_melt)
