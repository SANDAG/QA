...
persons_i27<-read.csv('T:\\socioec\\Current_Projects\\XPEF11\\abm_csv\\persons_2016_01.csv',stringsAsFactors = FALSE ,fileEncoding="UTF-8-BOM")
persons_i28<-read.csv('T:\\socioec\\Current_Projects\\XPEF10\\abm_csv\\persons_2016_01.csv',stringsAsFactors = FALSE ,fileEncoding="UTF-8-BOM")
...
#save output
write.csv(persons_16s, "M:\\Technical Services\\QA Documents\\Projects\\Base Year_Popsyn\\4_Data Files\\ouput files\\persons_28_27.csv",row.names = FALSE )
...
#save output
write.csv(persons_16s_sum, "M:\\Technical Services\\QA Documents\\Projects\\Base Year_Popsyn\\4_Data Files\\ouput files\\persons_28_27_sum.csv",row.names = FALSE )
