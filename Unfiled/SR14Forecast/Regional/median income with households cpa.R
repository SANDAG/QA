...
inc_abm_13$income_group_id <-as.character(inc_abm_13_cpa$income_group_id)
...
inc_abm_13$interval_width<-inc_abm_13$upper_bound-inc_abm_13$lower_bound +1

inc_abm_13_jur<-inc_abm_13
inc_abm_13_cpa<-inc_abm_13

inc_abm_13_jur<-aggregate(hh~jurisdiction_2015+yr+income_group_id, data = inc_abm_13_ju, sum)
inc_abm_13_cpa<-aggregate(hh~cpa_13+yr+income_group_id, data = inc_abm_13_cpa, sum)

inc_abm_13_jur<- inc_abm_13_jur[order(inc_abm_13_jur$cpa_13,inc_abm_13_jur$yr,inc_abm_13_jur$income_group_id),]
