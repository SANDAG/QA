-- datasource 17 query for capacity
SELECT '17' as ID,jcpa,jcpa_name, sum(COALESCE(capacity_3,capacity_2)) as jur_provided_cap, 
    ...
    LEFT JOIN   (SELECT * FROM [urbansim].[urbansim].[additional_capacity]
                WHERE additional_capacity.version_id = 108) as additional_cap
